...
class DecrypterOperator:
    ...
    def get_coordenates2(self, input:str) -> int:
        ...
        length = len(decrypted_numbers)
        numbers = [num for _, num, _ in decrypted_numbers]
        zero_idx = numbers.index(0)
        first_coor = numbers[(zero_idx + 1000) % length]
        second_coor = numbers[(zero_idx + 2000) % length]
        third_coor = numbers[(zero_idx + 3000) % length]
